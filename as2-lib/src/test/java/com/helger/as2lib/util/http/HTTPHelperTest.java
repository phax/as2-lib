...
public class HTTPHelperTest
{
  ...
  String sRegularMessage, sChunkedMessage, sRegularMessageBody, sChunkedMessageBody, sNoLengthMessage,
  ...
  private boolean compareLineByLine (InputStream is1, InputStream is2) throws IOException
  {
    ...
    {
      System.out.printf ("input streams has different No of lines: %d, and %d", is1Lines.size (), is2Lines.size ());
      return false;
    }
  ...
  public void init ()
  {
    sRegularMessageBody = "------=_Part_1_462911221.1531652105780\r\n" +
                          ...
                          "------=_Part_1_462911221.1531652105780--\r\n";
    sRegularMessage = "POST /HttpReceiver HTTP/1.1\r\n" +
    ...
    sChunkedMessage = "POST /HttpReceiver HTTP/1.1\r\n" +
                      ...
                      "\r\n" +
                      "0\r\n";
    sNoLengthMessage = "POST /HttpReceiver HTTP/1.1\r\n" +
                       "Content-Type: multipart/signed; protocol=\"application/pkcs7-signature\"; micalg=sha-512;    boundary=\"----=_Part_1_1029148906.1531651777438\"\r\n" +
                       "Subject: [-Dlog4j2.debug, --stream, --sign]\r\n" +
                       "Message-ID: <ph-OpenAS2-15072018134936+0300-1718@testsender_testreceiver>\r\n" +
                       "Content-Disposition: attachment; filename=dummy.txt\r\n" +
                       ...
                       "\r\n" +
                       "0\r\n";
    sBadTransferEncodingMessage = "POST /HttpReceiver HTTP/1.1\r\n" +
                                  "Content-Type: multipart/signed; protocol=\"application/pkcs7-signature\"; micalg=sha-512;    boundary=\"----=_Part_1_1029148906.1531651777438\"\r\n" +
                                  "Subject: [-Dlog4j2.debug, --stream, --sign]\r\n" +
                                  "Message-ID: <ph-OpenAS2-15072018134936+0300-1718@testsender_testreceiver>\r\n" +
                                  "Content-Disposition: attachment; filename=dummy.txt\r\n" +
